    ...
    where TEnum : struct, Enum
{
    ...
    public TRaw Raw()
    {
        try
        {
            return JsonSerializer.Deserialize<TRaw>(this.Json, ModelBase.SerializerOptions)
                ?? throw new AutorenderInvalidDataException($"{nameof(this.Json)} cannot be null");
        }
        catch (JsonException e)
        {
            throw new AutorenderInvalidDataException(
    ...
    public void Validate()
    {
        ...
        {
            throw new AutorenderInvalidDataException("Invalid enum value");
        }
    }
