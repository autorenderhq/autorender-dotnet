...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<UploadCreateFromUrlResponse, UploadCreateFromUrlResponseFromRaw>)
)]
public sealed record class UploadCreateFromUrlResponse : JsonModel
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UploadCreateFromUrlResponse(UploadCreateFromUrlResponse uploadCreateFromUrlResponse)
        : base(uploadCreateFromUrlResponse) { }
#pragma warning restore CS8618

    public UploadCreateFromUrlResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UploadCreateFromUrlResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="UploadCreateFromUrlResponseFromRaw.FromRawUnchecked"/>
    public static UploadCreateFromUrlResponse FromRawUnchecked(
...
class UploadCreateFromUrlResponseFromRaw : IFromRawJson<UploadCreateFromUrlResponse>
{
    /// <inheritdoc/>
    public UploadCreateFromUrlResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => UploadCreateFromUrlResponse.FromRawUnchecked(rawData);
}
