...
public class UploadUploadWithTokenResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UploadUploadWithTokenResponse
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UploadUploadWithTokenResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UploadUploadWithTokenResponse copied = new(model);
