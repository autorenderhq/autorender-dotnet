...
public class RetriesTest : TestBase
{
    ...
    public async Task ImmediateSuccess_Works()
    {
        ...
        AutorenderClient client = new() { HttpClient = httpClient, MaxRetries = 2 };
    ...
    public async Task RetryAfterMsHeader_Works()
    {
        ...
        AutorenderClient client = new() { HttpClient = httpClient, MaxRetries = 1 };
